...
in mkWindowsApp rec {
  ...
  pname = "songtaggerforspotify";
  version = "1.2.8";

  src = builtins.fetchurl {
    url = "https://github.com/BenediktAlkin/SongTaggerForSpotify/releases/download/v${version}/SongTaggerForSpotify-Windows.zip";
    #check error message
    sha256 = "sha256:0c0dl2kpwkdjzh3ia5j4a5ar36b36dpv4jzmi070d64r0ma3kd01";
  };
  ...
  winAppInstall = ''
    ...
    config_dir="$HOME/.config/songtaggerforspotify"
  ...
  winAppRun = ''
    wine "$WINEPREFIX/drive_c/${pname}/SpotifySongTagger.exe" "$ARGS"
  '';
  ...
  in [
    (makeDesktopItem {
      ...
      exec = pname;
      icon = pname;
      desktopName = "SongTaggerForSpotify";
  ...
  desktopIcon = makeDesktopIcon {
    name = "SongTaggerForSpotify";

    src = fetchurl {
      url = "https://github.com/BenediktAlkin/SongTaggerForSpotify/raw/v${version}/logo.png";
      sha256 = "sha256-VCFmXDgRdkKAB1wXkiQnBVmo3sEFY9dEXeL1VJKba88=";
    };
  };

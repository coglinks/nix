-- NOTE: The following configuration is taken from https://github.com/linkarzu/dotfiles-latest/blob/4ac00c8653025da331d43adfb892dc7a67ea4c6a/neovim/nvim-lazyvim/lua/plugins/img-clip.lua. I have edited the options to preference while leaving the author's comments alone. So you'll say some wierd stuff wrt that.
